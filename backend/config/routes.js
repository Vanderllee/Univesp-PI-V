...
module.exports = app => {
    ...
    app.route('/categories')
        .all(app.config.passport.authenticate())
        .get(admin(app.api.categories.getCategories))
    ...
    app.route('/categories/:id')
        .all(app.config.passport.authenticate())
        .get(app.api.categories.getCategory)
        .put(admin(app.api.categories.save))
        .delete(admin(app.api.categories.categoryRemove))
    ...
    app.route('/categories/:id/articles')
        .all(app.config.passport.authenticate())
        .get(app.api.articles.getArticlesByCategories)

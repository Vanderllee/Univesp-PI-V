module.exports = app => {
    ...
    const categoryRemove = async (req, res) => {
        try {
            existsOrError(req.params.id, 'O código da Categoria não foi informado')
            ...
            existsOrError(deletedRows, 'Categoria não foi encontrada')
    ...
    return { save, getCategory, getCategories, categoryRemove, getTree}
}